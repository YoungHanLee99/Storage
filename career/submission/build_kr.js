...
P([R("현재 자리에서는 그룹 내부조사를 직접 수행·종결하고 있습니다. ", { bold: true }),
   R("제보 접수와 트리아지, 조사 착수 여부 및 범위 결정, 관계자 인터뷰, 사내 자료·데이터 검토, 사실관계 확정, 징계 권고와 제도 개선까지 전 과정을 맡습니다. "),
   R("특히 직장 내 괴롭힘 신고 사건을 다수 조사", { bold: true }),
   R("했으며, 근로기준법 제76조의3상 법정 조사의무에 따라 접수 즉시 피해자 보호조치를 시행하고 지체 없이 조사를 개시하며, 종결 후 보복 여부를 별도로 모니터링합니다.")]),
...
H("2. 핵심 역량"),
B([R("내부조사 수행 및 종결", { bold: true }), R(" — 제보 인테이크·트리아지, 착수 여부 및 범위 결정, 인터뷰, 자료 검토, 결론 도출, 시정 권고까지 전 과정")]),
B([R("HR 조사", { bold: true }), R(" — 직장 내 괴롭힘 신고 사건 다수 조사 (근로기준법 §76조의3 법정 조사)")]),
...
B([R("그룹 내부조사 직접 수행 및 종결", { bold: true }), R(" — 제보 접수 및 트리아지, 조사 착수 여부·범위 결정, 관계자 인터뷰, 사내 자료·데이터 검토, 사실관계 확정, 징계 권고 및 재발방지 조치까지 전 과정")]),
B([R("직장 내 괴롭힘 신고 사건 다수 조사", { bold: true }), R(" — 근로기준법 제76조의3상 법정 조사의무에 따라 접수 즉시 피해자 보호조치 시행 후 지체 없이 조사 개시, 조사 결과에 따른 징계 권고 및 종결 후 보복 여부 모니터링")]),
B("비위·이해상충·정책위반 사안 조사 — 피조사자가 보고선에 있는 경우 이해충돌 차단 구조를 별도 설계하여 수행"),
B("조사 결론의 법적 번역 — 형법상 횡령·배임 해당 여부 및 고소 실익 판단, 징계 절차의 적법성 검토"),
...
H2("조사 · 형사 · 규제"),
B([R("㈜디스트릭트코리아 내부조사 — 비위·이해상충·정책위반 사안을 제보 접수부터 종결까지 직접 수행", { bold: true })]),
B([R("직장 내 괴롭힘 신고 사건 조사 — 접수 즉시 보호조치, 지체 없는 조사 개시, 징계 권고, 사후 보복 모니터링 (근로기준법 §76조의3)", { bold: true })]),
